...
data = preprocess_numerical.preprocess_mean(data, ['First GCS on Critical Care admission', 'Lowest temp', 'Highest HR', 'Lowest HR','Highest RR', 'Lowest RR', 'Lowest GCS'])   
...
#data = preprocess_numerical.preprocess_mean(data, ['Hb_1', 'Haematocrit_1', 'WBC_1', 'Neutrophils_1', 'Platelets_1', 'Na_1', 'K_1', 'Urea_1', 'Creatinine_umolperL_1', 'Bilirubin_1', 'Albumin_1', 'Hb_2', 'Haematocrit_2', 'WBC_2', 'Platelets_2', 'Na_2', 'K_2', 'Urea_2', 'Creatinine_mgperdL_2', 'Creatinine_umolperL_2', 'Bilirubin_2', 'First pH on Admission to Critical Care', 'FiO2_1', 'PaCo2 kPa_1', 'PaO2 kPa_1', 'Aa gradient_1', 'PaO2 mmHg_1', 'PaO2_FiO2_1', 'BiCarb_1', 'Lactate_1', 'FiO2_2', 'pH_1', 'FiO2_3', 'PaCo2 kPa_2', 'PaO2 kPa_2', 'Aa gradient_2', 'PaO2 mmHg_2', 'PaO2_FiO2_2', 'Worst PaO2:FiO2 ratio', 'BiCarb_2', 'Lactate_2', 'FiO2_4', 'Number of Days in Critical Care'])       
