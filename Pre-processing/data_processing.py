...
data = pd.read_excel(r"data\Source_bloods_removed.xlsx", engine="openpyxl")
...
#Further Oncological Treatment one hot encoding
#data = encoder_treatment_categories.encode_treatment_categories(data, "Further Oncological Treatment?")
...
#YES / No  Imputations
data = pre_process_numerical.preprocess_yes_no(data, ['Cardiac arrest_1','Cardiac arrest_2','Direct admission from theatre?','Features of sepsis?', 'Haemodialysis /CRRT', 'AKI y/n', 'Acute renal failure_2', 'Acute renal failure_1'])
